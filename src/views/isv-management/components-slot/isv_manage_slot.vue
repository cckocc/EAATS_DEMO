      ...
      >
        <template v-slot:node="{ node }">
          <span v-if="node.nodeType == 0">
            ...
            <!-- <span v-else>
              <span v-if="node.isSupport" align="center">
                <span v-if="node.isSupport == 1"> 不支持 </span>
                <span v-if="node.isSupport == 0"> 支持 </span>
              </span>
              <span v-else> 暂无 </span>
            </span> -->
          </span>
          ...
          <span v-else-if="node.nodeType == 1">
            ...
            <span v-else>
              <span v-if="node.cfetsCheckStatus == '01'"> 未发起 </span>
              <span v-if="node.cfetsCheckStatus == '00'"> 待审核 </span>
              <span v-else-if="node.cfetsCheckStatus == '05'"> 审核中 </span>
              <span v-else-if="node.cfetsCheckStatus == '10'"> 通过 </span>
              <span v-else-if="node.cfetsCheckStatus == '90'"> 拒绝 </span>
            </span>
          </span>
