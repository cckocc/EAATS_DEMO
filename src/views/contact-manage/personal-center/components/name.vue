<template>
  <div v-loading="loading" class="body">
    <div>
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="54px" label-position="left">

        <el-form-item label="姓名" prop="sname">
          <el-input v-model="ruleForm.sname" v-limitBytes="90" autocomplete="off" placeholder="" />
        </el-form-item>
        <!-- <el-form-item label="座机" prop="telNo">
          <div class="prepend">
            <el-input v-model="ruleForm.telNoAreaCode" class="area-code" placeholder="区号" />
            <span class="solid" />
            <el-input v-model="ruleForm.telNo" placeholder="地方号码" />
          </div>
        </el-form-item> -->
        <el-form-item v-if="userInfo.userInnerType.code === '00'" label="座机" required>
          <el-col :span="6">
            <el-form-item prop="telNoAreaCode" class="inner-panel">
              <el-input v-model="ruleForm.telNoAreaCode" placeholder="区号" class="tel-code" maxlength="20" />
            </el-form-item>
          </el-col>
          <el-col :span="17" :offset="1">
            <el-form-item prop="telNo" :rules="rules.telNoOrg" class="inner-panel">
              <el-input v-model="ruleForm.telNo" placeholder="请输入地方号码" clearable class="tel" maxlength="20" />
            </el-form-item>
          </el-col>
        </el-form-item>
        <el-form-item v-if="userInfo.userInnerType.code === '05'" label="座机" required>
          <el-col :span="6">
            <el-form-item class="inner-panel">
              <el-input v-model="ruleForm.telNoAreaCode" v-limitBytes="50" placeholder="区号" class="tel-code" />
            </el-form-item>
          </el-col>
          <el-col :span="17" :offset="1">
            <el-form-item prop="telNo" :rules="rules.telNoGrip" class="inner-panel">
              <el-input v-model="ruleForm.telNo" v-limitBytes="200" placeholder="请输入地方号码" clearable class="tel" />
            </el-form-item>
          </el-col>
        </el-form-item>
        <div class="btn">
