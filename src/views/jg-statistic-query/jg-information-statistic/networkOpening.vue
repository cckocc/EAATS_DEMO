...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      ...
      // if (this.networkForm.openTime && this.networkForm.openTime.length > 0) {
      //   this.networkForm.startTime = this.networkForm.openTime[0]
      //   this.networkForm.endTime = this.networkForm.openTime[1]
      // } else {
      //   this.networkForm.startTime = ''
      //   this.networkForm.endTime = ''
      // }
    ...
    async onQuery(networkForm) {
      ...
      reqQueryNetwork({
        ...
        startTime:
          this.networkForm.openTime && this.networkForm.openTime.length > 0
            ? this.networkForm.openTime[0]
            : '',
        endTime:
          this.networkForm.openTime && this.networkForm.openTime.length > 0
            ? this.networkForm.openTime[1]
            : '',
        institutionType: '10',
        ...this.pageQuery
      })
