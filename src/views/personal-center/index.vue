        ...
        <div class="collapse">
          <div class="collapse-item">
            <div class="header">
              ...
              <div class="header-right">
                <div class="title">
                  <span class="title-l">{{ $t('userCenter.nameAndTelephone') }}</span>
                </div>
                <div class="btn">
                  <template v-if="isBinding(userInfo.telNo)">
                    <img src="@/assets/icon/right.png" alt="">
                    <el-button type="text" class="btn-set">{{ $t('userCenter.set') }}</el-button>
                    <el-divider direction="vertical" />
                  </template>
                  <el-button type="text" class="btn-collapse" @click="ishow4 = !ishow4">{{ ishow4 ? $t('userCenter.collapse'):$t('userCenter.edit') }}</el-button>
                </div>
              </div>
            </div>
          ...
          <div class="collapse-item">
            <div class="header">
              ...
              <div class="header-right">
                <div class="title">
                  <span class="title-l">{{ $t('common.password') }}</span>
                </div>
                <div class="btn">
                  <img src="@/assets/icon/right.png" alt="">
                  <el-button type="text" class="btn-set">{{ $t('userCenter.set') }}</el-button>
                  <el-divider direction="vertical" />
                  <el-button type="text" class="btn-collapse" @click="ishow = !ishow">{{ ishow ? $t('userCenter.collapse'):$t('userCenter.edit') }}</el-button>
                </div>
              </div>
            </div>
            <el-collapse-transition>
          ...
          <div class="collapse-item">
            <div class="header">
              ...
              <div class="header-right">
                <div class="title">
                  <span class="title-l">{{ $t('userCenter.bindMobilePhoneNumber') }}</span>
                  <span class="title-r">{{ userInfo.phoneNo }}</span>
                </div>
                <div class="btn">
                  <template v-if="isBinding(userInfo.phoneNo)">
                    <img src="@/assets/icon/right.png" alt="">
                    <el-button type="text" class="btn-set">{{ $t('userCenter.bound') }}</el-button>
                    <el-divider direction="vertical" />
                  </template>
                  <el-button type="text" class="btn-collapse" @click="ishow2 = !ishow2">{{ ishow2 ? $t('userCenter.collapse'):$t('userCenter.edit') }}</el-button>
                </div>
              </div>
            </div>
            <el-collapse-transition>
          ...
          <div class="collapse-item">
            <div class="header">
              ...
              <div class="header-right">
                <div class="title">
                  <span class="title-l">{{ $t('userCenter.bindEmail') }}</span>
                ...
                <div class="btn">
                  ...
                  <el-button type="text" class="btn-collapse" @click="ishow3 = !ishow3">{{ ishow3 ? $t('userCenter.collapse'):$t('userCenter.edit') }}</el-button>
                </div>
              </div>
            </div>
            <el-collapse-transition>
