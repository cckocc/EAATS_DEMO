    ...
    >
      ...
      <div class="top">
        ...
        <el-row>
          <div class="top-row">
            <el-col :span="8">
              <el-form-item label="市场" prop="market" label-width="40px">
      ...
      <div class="middle">
        ...
        >
          <el-table-column show-overflow-tooltip prop="market" label="市场\接口产品" min-width="350" />
          <el-table-column show-overflow-tooltip prop="interface" label="接口用途" min-width="680" />
