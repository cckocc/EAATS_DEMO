...
export default {
  ...
  computed: {
    ...
    insertDateContent() {
      return JSON.parse(JSON.stringify(this.dataContent))
    }
  },
  watch: {
    // value: {
    ...
    insertDateContent(newVal, oldVal) {
      // if (newVal) {
  ...
  methods: {
    ...
    initTinymce() {
      ...
      tinymce.init({
        ...
        font_formats: '宋体=宋体;黑体=黑体;仿宋=仿宋;微软雅黑=微软雅黑;楷体-GB2312=楷体-GB2312Andale Mono=andale mono,times; Arial=arial,helvetica,sans-serif; Arial Black=arial black,avant garde; Book Antiqua=book antiqua,palatino; Comic Sans MS=comic sans ms,sans-serif; Courier New=courier new,courier; Georgia=georgia,palatino; Helvetica=helvetica; Impact=impact,chicago; Symbol=symbol; Tahoma=tahoma,arial,helvetica,sans-serif; Terminal=terminal,monaco; Times New Roman=times new roman,times; Trebuchet MS=trebuchet ms,geneva; Verdana=verdana,geneva; Webdings=webdings; Wingdings=wingdings,zapf dingbats',
        ...
        link_title: false,
        // 自定义元素
        extended_valid_elements: 'custom[custom|style]',
    ...
    insertElement() {
      this.$nextTick(() => {
        if (this.dataContent) {
          window.tinymce.get(this.tinymceId).insertContent(this.dataContent, {
