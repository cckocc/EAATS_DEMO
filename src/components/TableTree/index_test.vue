              ...
              >
                <div class="td-container">
                  ...
                  <template v-if="showCheckbox">
                    ...
                    <span v-else>
                      <span v-if="tdData.nodeType == 0">
                        <span v-if="editFlagInterface">
                          <el-switch
                            v-model="tdData.isSupport"
                            active-value="0"
                            inactive-value="1"
                            active-color="#4173CB"
                        ...
                        <span v-else>
                          <span v-if="tdData.isSupport" align="center">
                            <span v-if="tdData.isSupport == 1">
                              <img
                                src="~@/assets/style/ISV_icon_fork.svg"
                                alt=""
                              >
                            </span>
                            <span v-if="tdData.isSupport == 0">
                              <img
                                src="~@/assets/style/ISV_icon_support.svg"
                                alt=""
                              >
                            </span>
                          </span>
                      ...
                      <span v-else-if="tdData.nodeType == 1">
                        <span
                          v-if="
                            editFlagInterface &&
                              userinfo.userInnerType.code !== '00'
                          "
                        >
                          <el-select v-model="tdData.cfetsCheckStatus">
                            <el-option
                        ...
                        <span v-else>
                          <span v-if="tdData.cfetsCheckStatus == '01'">
                            <!-- 未发起 -->
                            <img
                              src="~@/assets/style/ISV_icon_fork.svg"
                              alt=""
                          ...
                          <span v-if="tdData.cfetsCheckStatus == '00'">
                            待审核
                            <!-- <img src="~@/assets/style/ISV_icon_fork.svg" alt="">  -->
                          </span>
                          <span v-else-if="tdData.cfetsCheckStatus == '05'">
                            审核中
                            <!-- <img src="~@/assets/style/ISV_icon_fork.svg" alt="">  -->
                          </span>
                          <span v-else-if="tdData.cfetsCheckStatus == '10'">
                            通过
                            <!-- <img src="~@/assets/style/ISV_icon_support.svg" alt=""> -->
                          </span>
                          <span v-else-if="tdData.cfetsCheckStatus == '90'">
                            拒绝
                            <!-- <img src="~@/assets/style/ISV_icon_fork.svg" alt="">  -->
                          </span>
                        </span>
                      ...
                      <span v-if="tdData.nodeType != 1 && tdData.nodeType != 0">
                        {{ tdData.nodeName }}
                      </span>
                    </span>
                  </template>
...
export default {
  ...
  watch: {
    ...
    // editFlagInterface: {
    //   handler(newVal, oldVal) {
    //     this.editFlagInterface = newVal
    //     console.log('this.editFlagInterface', this.editFlagInterface)
    //   },
    //   immediate: true,
    //   deep: true
    // }
  ...
  methods: {
    // aaa(ssss) {
    //   console.log('222', ssss)
    //   this.editFlagInterface = ssss
    // },
    // 判断是否会出现滚动条
    checkHasScrollerbar() {
        ...
        nodeRules.relateKeys.forEach((relateKey) => {
          ...
          if (relateNode) {
            ...
            if (relateType === 'different' && val === '10') {
              if (relateNode.nodeOptionalStatus.code === '10') {
